...
class ReceiversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receiver" do
    assert_difference("Receiver.count") do
      post receivers_url, params: { receiver: { address: @receiver.address, name: @receiver.name } }
    end
  ...
  test "should update receiver" do
    patch receiver_url(@receiver), params: { receiver: { address: @receiver.address, name: @receiver.name } }
